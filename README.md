...
- **Portfolio Allocation Dashboard Live** — Evaluates a 75-ticker broad-market universe with $100,000 virtual capital. Banks bypass solvency checks via a sector exception guard. Live market prices determine integer-only share targets. Outputs a ranked 6-column terminal table: Ticker, Solvency Status, Net Sentiment Score, Allocation %, Dollar Capital, and Target Shares.
